...
try {
    ...
    foreach ($name in @('acceptance.md','architecture.md','distribution.md','test-results.md','sources.md','schema-compatibility.md','input-compatibility.md','release-notes.md')) { Copy-Item -LiteralPath (Join-Path $root "docs\$name") -Destination (Join-Path $stage 'docs') }
