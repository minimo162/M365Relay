...
export const DOM_OPERATIONS = Object.freeze(['snapshot','verifyInput','focus','send','newChat','stop']);
...
export function safeDiagnostics(value) {
  ...
  const out={};
  const enums={
    stage:['m365_dom','editor_input','backend'], dom_operation:DOM_OPERATIONS, dom_reason:DOM_REASONS, dom_tag:DOM_TAGS,
    backend_phase:['connect','open_tab','attach_tab','wait_editor','reset_conversation','input_before','input_focus','input_insert','input_settle','before_send','send','response_wait','response_validate','cleanup'],
